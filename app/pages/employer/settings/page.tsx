...
export default function AccountSettings() {
  ...
  return (
      ...
      >
        ...
        <div className="bg-white/80 backdrop-blur-md shadow-lg rounded-xl p-5 mb-4 flex items-center justify-between">
        ...
        <div className="bg-red-50 shadow-lg rounded-xl p-5 border border-red-400 flex items-center justify-between">
          <div className="flex items-center gap-3">
